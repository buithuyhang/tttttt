...
namespace QuanLyTaiKhoan
{
    public static class Context
    {
        ...
        public static HT_Quyen ThemQuyen(string NhomQuyen, string TenQuyen, string Rule)
        {
            if (DB.HT_Quyens.FirstOrDefault(q => q.Rule == Rule && q.NhomQuyen == NhomQuyen) == null)
            {
            ...
            return DB.HT_Quyens.FirstOrDefault(q => q.Rule == Rule && q.NhomQuyen == NhomQuyen);
        }
        ...
        /// <returns>Quyền trong hệ thống.</returns>
        /// <param name="TenQuyen">tên quyền.</param>
        public static HT_Quyen ThemQuyen(string TenQuyen, string Rule)
        {
            return ThemQuyen(PERMISSION_DEFAULT_GROUP, TenQuyen, Rule);
        }

        public static void XoaQuyen(long IDQuyen)
        {
            var quyen = DB.HT_Quyens.FirstOrDefault(q => q.IDQuyen == IDQuyen);
            if (quyen != null)
            {
                DB.HT_Quyens.DeleteOnSubmit(quyen);
                DB.SubmitChanges();
            }
        }
        ...
        public static List<HT_PhanQuyen> DanhSachPhanQuyen()
        {
            return DB.HT_PhanQuyens.ToList();
        }
        #endregion
    }
}
