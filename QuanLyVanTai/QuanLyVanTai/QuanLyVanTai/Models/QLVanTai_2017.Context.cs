...
namespace Test.Models
{
    ...
    public partial class QLVanTai_2017 : DbContext
    {
        ...
        public virtual ObjectResult<Tuyen_Duoi70_Result> Tuyen_Duoi70(Nullable<int> thang, Nullable<int> nam, Nullable<int> id_So, Nullable<long> id_Tuyen)
        {
            var thangParameter = thang.HasValue ?
                new ObjectParameter("Thang", thang) :
                new ObjectParameter("Thang", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Tuyen_Duoi70_Result>("Tuyen_Duoi70", thangParameter, namParameter, id_SoParameter, id_TuyenParameter);
        }
